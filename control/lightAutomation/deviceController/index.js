...
functions.printLastRooms = function(){                  //logs 'hasBeenInRoom' to console
    ...
    hasBeenInRoom.forEach(function(currentRoom){
        console.log(currentRoom);
    });
    console.log("hasBeenInRoom");
