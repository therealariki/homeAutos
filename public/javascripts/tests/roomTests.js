...
var testItem;
before(function () {
    var states = ["OFF", "OFF", "OFF", "OFF", "OFF", "OFF", "OFF", "OFF", "OFF", "OFF"];
    var count = 0;
...
//Normalize 'test' points array 
describe('normalizePoints', function () {
    it('should return array of points 1 hundred their original size', function () {
        assert.deepEqual(normalizePoints(100, 100, [[30, 30], [40, 40]]), [[0.3, 0.3], [0.4, 0.4]]);
    });
});

//Test screen res* function (RESPONSIVE DES)
